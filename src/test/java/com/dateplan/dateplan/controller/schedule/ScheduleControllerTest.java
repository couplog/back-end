...
public class ScheduleControllerTest extends ControllerTestSupport {
	...
	class DeleteRepeatedSchedule {
		...
		@DisplayName("올바른 memberId, scheduleId를 입력하면 반복 일정이 전체 삭제된다.")
		@Test
		void successWithValidRequest() throws Exception {
		...
		@Test
		void failWithInvalidPathVariable() throws Exception {
		...
		@DisplayName("올바르지 않은 request parameter를 입력하면 실패한다.")
		@Test
		void failWithInvalidRequestParamter() throws Exception {
